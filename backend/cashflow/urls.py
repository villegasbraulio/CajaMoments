...
from .views import (
    ...
    EventPaymentPreferencePublicAPIView,
    EventPaymentPublicAPIView,
    EventBudgetViewSet,
...
urlpatterns = [
    ...
    path("event-payments/<uuid:token>/public/", EventPaymentPublicAPIView.as_view(), name="event-payment-public"),
    path("event-payments/<uuid:token>/create-preference/", EventPaymentPreferencePublicAPIView.as_view(), name="event-payment-public-preference"),
